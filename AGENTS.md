...
| `TipTour/Utilities/TipTourDefaults.swift` | ~136 | Centralized UserDefaults facade for persisted app preferences and first-run defaults such as Autopilot, CUA, Hermes/Pipecat connection toggles, screenshots, panel pinning, and permission memory. |
